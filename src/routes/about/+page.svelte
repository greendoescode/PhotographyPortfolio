...
<main class="bg-cover bg-center" style="background-image: url('/images/_DSC3786.jpg');">
		...
		<div class="container mx-auto text-center">
			...
			<div class="bg-white bg-opacity-90 rounded-lg p-8 shadow-md max-w-3xl mx-auto">
				<div class="flex justify-center">
					<img src="/images/profile.jpg" alt="Leo Hanney" class="w-40 h-40 rounded-full object-cover mx-auto mb-4 shadow-lg" />
				</div>
