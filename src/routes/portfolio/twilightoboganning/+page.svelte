<script>
  ...
  let collections = [
    {
      name: "Mendip Ski Tobogganing",
      images: Array.from({ length: 23 }, (_, i) => 
        `/images/twilightoboganning/image${i + 1}.avif`
      ),
    },
  ];
  ...
  function getImageMetadata(imageUrl) {
    return {
      caption: "Mendip Ski Tobogganing",
      exif: {
        camera: "Nikon Z6",
        lens: "40mm f/2",
        aperture: "?",
...
<svelte:head>
  ...
  <title>Tobogganing - Leo Hanney</title>
  <meta property="og:title" content="Twilight Tobogganing - Leo Hanney" />
  <meta property="og:description" content="A collection from Mendip Ski Tobogganing." />
  <meta property="og:image" content="/images/twilightoboganning/image1.avif" />
</svelte:head>
...
<div>
  ...
  <section id="portfolio" class="py-5">
    <div class="container mx-auto mt-20 text-center">
      <h1 class="text-5xl font-bold text-white mb-4">Mendip Ski Twilight Tobogganing</h1>
      <p class="text-lg font-bold text-white mb-8">
        A twilight session captured at the toboggan slope for Mendip Activity Centre.
      </p>
