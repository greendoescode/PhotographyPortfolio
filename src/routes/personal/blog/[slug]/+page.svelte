<script>
  ...
  // Blog posts with support for text, images, and links
  const posts = {
    1: {
    ...
    2: {
      ...
      content: [
        ...
        {
          type: "text",
          value: "Well thank you for reading, this was a bit indulgent and a bit strange but who caaaaaaaareeeeeeees!"
        },
        {
          type: "image",
